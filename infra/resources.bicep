...
// ===================== //
// AZD Pattern: ACR Container App - Single Next.js App
// ===================== //

module containerApp 'br/public:avm/ptn/azd/acr-container-app:0.4.0' = {
  name: 'container-app'
  params: {
...
output appContainerAppUrl string = containerApp.outputs.uri
